...
### All quests are specified in the table and then called in "SetQuest", where the quest string is specified
![demo img 2](https://github.com/paveldrobny/UE4_QuestSystem_BP/blob/master/ue4_questsystem_5.png?raw=true)
...
![demo img 4](https://github.com/paveldrobny/UE4_QuestSystem_BP/blob/master/ue4_questsystem_2.png?raw=true)

### Final view
![demo img 5](https://github.com/paveldrobny/UE4_QuestSystem_BP/blob/master/ue4_questsystem_4.png?raw=true)
